...
@property(strong,nonatomic)NSMutableArray<PFPublishButton *> *btnArray;
...
-(NSMutableArray<PFPublishButton *> *)btnArray
{
    if(_btnArray == nil)
    {
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        addbtn.bounds = CGRectMake(0, 0, 60, 60);
        
        addbtn.center=CGPointMake(ScreenWidth/2, ScreenHeight-40);
...
-(void)addButton
{
    ...
    for (NSUInteger i=0; i<buttonCount; i++) {
        ...
        PFPublishButton *btn=[PFPublishButton buttonWithType:UIButtonTypeCustom];
...
-(void)pushButton
{
    ...
    if(!self.isAnimation)
    {
        ...
        for (NSInteger i = 0; i < self.btnArray.count; i++) {
                ...
                PFPublishButton *menuButton = self.btnArray[i];
